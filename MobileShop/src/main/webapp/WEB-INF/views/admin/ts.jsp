		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/ts">Type sim</a><span
...
<div class="row">
	...
	<form:form modelAttribute="filter" action="/admin/ts" method="get" class="form-inline">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/ts" method="POST" modelAttribute="ts">
				<div class="form-group">
...
<div class="row">
			<div class="col-md-2 col-xs-2"><h3>Type sim name</h3></div>
			...
			<c:forEach items="${page.content}" var="ts">
				<div class="row">
					<div class="col-md-2 col-xs-2">${ts.name}</div>
					
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning" href="/admin/ts/update/${ts.id}<custom:allParams/>">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/ts/delete/${ts.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
