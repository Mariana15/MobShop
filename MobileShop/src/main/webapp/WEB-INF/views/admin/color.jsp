...
<div class="row">
	...
	<div class="row">
			<div class="col-md-2 col-xs-2"><h3>Color name</h3></div>
			...
			<c:forEach items="${page.content}" var="color">
				<div class="row">
					<div class="col-md-2 col-xs-2">${color.name}</div>
					
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning" href="/admin/color/update/${color.id}<custom:allParams/>">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/color/delete/${color.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
