...
public interface ItemRepository extends JpaRepository<Item, Integer>, JpaSpecificationExecutor<Item> {
	...
	@Query(value = "SELECT  i FROM Item i LEFT JOIN FETCH i.category LEFT JOIN FETCH i.producer LEFT JOIN FETCH i.camera  LEFT JOIN FETCH i.os  LEFT JOIN FETCH i.color LEFT JOIN FETCH i.diagonal LEFT JOIN FETCH i.fc LEFT JOIN FETCH i.memory LEFT JOIN FETCH i.noc LEFT JOIN FETCH i.nosc LEFT JOIN FETCH i.ts  ", countQuery = "SELECT count(i.id) FROM Item i")
