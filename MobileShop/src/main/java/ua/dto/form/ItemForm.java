...
public class ItemForm {
	...
	public ItemForm(String name, String price, Producer producer,
			Category category, Color color, TypeSim ts, NumberOfCores noc,
			NumberOfSimCards nosc, Diagonal diagonal, Memory memory,
			Camera camera, FrontCamera fc, OS os, MultipartFile file) {
		super();
		this.name = name;
		this.price = price;
